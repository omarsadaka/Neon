...
public class HagsBaladyFragment extends Fragment {
    private RecyclerView recyclerView;
    private GetPostsAdapter getPostsAdapter;
    private List<Posts> postsList;
    private static final String URL = "https://neonsci.com/api/get_category_posts/?id=24&count=5&page=";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = getLayoutInflater().inflate(R.layout.fragment_hags_balady , container , false);

        recyclerView = view.findViewById(R.id.hags_recyclerview);
        recyclerView.setNestedScrollingEnabled(false);
        recyclerView.setHasFixedSize(true);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext() , LinearLayoutManager.VERTICAL , false);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = view.findViewById(R.id.post_progressBar);
        loadingProgress = view.findViewById(R.id.hags_loadindPB);
