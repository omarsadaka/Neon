...
import com.example.omar.neon.Activities.SecondHomeActivity;
...
public class HydrogenyaFragment extends Fragment {
    private RecyclerView recyclerView;
    private GetPostsAdapter getPostsAdapter;
    private List<Posts> postsList;
    private static final String URL = "https://neonsci.com/api/get_category_posts/?id=25&count=5&page=";
    private ProgressBar progressBar , loadingProgress;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = getLayoutInflater().inflate(R.layout.fragment_hydrogenya , container , false);
        recyclerView = view.findViewById(R.id.hydrogyna_recyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext() , LinearLayoutManager.VERTICAL , false);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = view.findViewById(R.id.post_progressBar);
        loadingProgress = view.findViewById(R.id.hydrogyna_loadindPB);
